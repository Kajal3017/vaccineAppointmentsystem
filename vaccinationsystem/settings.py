"""
Django settings for vaccinationsystem project.
...
SECRET_KEY = 'q!_h-d(swefezuu12#$h1c)$eb$dk+ce#iq&gwh*cfcew#l34&'
...
ROOT_URLCONF = 'vaccinationsystem.urls'
...
WSGI_APPLICATION = 'vaccinationsystem.wsgi.application'
